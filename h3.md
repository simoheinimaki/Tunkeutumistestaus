...
## e)
XSS-hyökkäyksessä voidaan esimerkiksi siepata toisen käyttäjän evästeet omalle koneelle. Kun saat toisen käyttäjän istuntoevästeen, voit siepata istunnon ilman salasanaa. Sepattuasi istunnon, voit suorittaa toimintoja tai kopioida tietoja uhrin nimissä.

## f)
Tässä kohtaa ZAP ja/tai FoxyProxy lakkasi toimimasta. En saa enään yhteyttä internetiin ollenkaan jos proxy oli päällä... Yritän uudestaan myöhemmin
## g)
